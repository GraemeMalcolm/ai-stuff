...
1. In the Azure portal, select the |<SPAN STYLE="text-decoration:overline"><u>>_</u></SPAN>| (*Cloud Shell*) button at the top of the page to the right of the search box. This opens a Cloud Shell pane at the bottom of the portal, as shown here.
